...
save(dpfr,file="4.24.17depSub.Rda")
```
...
docs <- tm_map(docs, removeWords, c("chris","jason","amy","noah","ezra","ike","noahs","chuck","jon","marlo","leta","nicholas","lottie","claire","jane","nielson","mr"))
